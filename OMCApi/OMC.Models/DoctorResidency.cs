...
{
    public class DoctorResidency : BaseEntity
    {
    ...
    public class DoctorResidencyResponse
    {
        public string Message { get; set; }
        public bool IsSuccess { get; set; }
        public List<DoctorResidencyDisplay> DoctorResidencyList { get; set; }
    }

    public class DoctorResidencyDisplay : DoctorResidency
    {
